    ...
    <div>
      <div className="JobInfoContainer">
        <div className="jobDescription">
          <p className="jobDate">
            18 Jul 2022 by <span>Coca Cola</span>
          </p>
          <h2>Senior Product & Brand Design</h2>
          ...
          <div className="overview">
            <p>
              ...
              where and how they worked, we acted, created two options to
              accomodate two different styles of work. On non-negotiable
              ...
              Learn more here. Please indicate which location(s) you're
              interested.
            </p>
          </div>
          ...
          <ul className="responsibilityList">
            ...
            <li>
              ...
              common interface pattern is better for UX than reinventing the
              wheel
            </li>
            <li>Ensure content strategy and design and perfectly in-sync</li>
            <li>
          ...
          <ul className="benefitsList">
            <li>We are remote-first company.</li>
            <li>
